    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center font-poppins max-w-5xl mx-auto'>
                ...
                <div className='grid grid-cols-3 md:grid-cols-4 gap-4 text-center items-center justify-center mt-2 mb-2'>
                ...
                <a href="https://drive.google.com/file/d/1C-vJosdSAjaC8i-u_GbmEY0mrgTmZ6WA/view?usp=drivesdk" target="blank"><button className="btn mb-5">Download CV</button></a>
            </div>
